...
<template>
  <div class="mx-auto max-w-6xl pt-28 pb-20">
    <motion.div v-bind="fadeUpSection">
      ...
      <p class="mt-4 text-sm font-semibold tracking-widest text-neutral-400 uppercase">Tulisan</p>
      <div class="mt-2 flex flex-wrap items-end justify-between gap-4">
        <div>
          <h1 class="text-3xl font-bold text-neutral-900 sm:text-4xl">Blogs</h1>
