...
<template>
  <div class="flex h-screen overflow-hidden bg-slate-100 dark:bg-slate-900">
    ...
    <main class="h-screen w-full overflow-y-auto p-5">
      <div class="mx-auto">
        <RouterView />
      </div>
    </main>
  ...
  <Modal :open="logoutModalOpen" @close="logoutModalOpen = false">
    <div class="space-y-5">
      <div>
        ...
        <h2 class="mt-2 text-2xl font-bold text-slate-900 dark:text-white">Logout from admin panel?</h2>
      </div>

      <div class="rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-600 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-400">
